package com.example.domiter.fileexplorer.service;
...
import com.example.domiter.fileexplorer.util.MediaScannerUtils;
import com.example.domiter.fileexplorer.util.Notifier;
...
public class ZipService extends IntentService {
    ...
    private static final String ACTION_COMPRESS = "com.example.domiter.fileexplore.action.COMPRESS";
    private static final String ACTION_EXTRACT = "com.example.domiter.fileexplore.action.EXTRACT";
    private static final String EXTRA_FILES = "com.example.domiter.fileexplore.action.FILES";
