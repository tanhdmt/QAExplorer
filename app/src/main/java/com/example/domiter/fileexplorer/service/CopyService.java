...
public class CopyService extends IntentService {
    ...
    private static final String ACTION_COPY = "com.example.domiter.fileexplorer.action.COPY";
    private static final String ACTION_MOVE = "com.example.domiter.fileexplorer.action.MOVE";
    private static final String EXTRA_FILES = "com.example.domiter.fileexplorer.action.FILES";
