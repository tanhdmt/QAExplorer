...
package com.example.domiter.fileexplorer.view;
...
public interface PathController {
     ...
     * See {@link com.example.domiter.fileexplorer.view.widget.PathView#switchToManualInput() switchToManualInput()}
     * and {@link com.example.domiter.fileexplorer.view.widget.PathView#switchToStandardInput() switchToStandardInput()}.
     */
    enum Mode {
        /**
    ...
    /**
     * @see com.example.domiter.fileexplorer.view.widget.PathView#cd(File)
     * @param path
